    ...
    <ShopContextProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/mens"
            element={<ShopCatagorey banner={men_banner} category="mens" />}
          />
          <Route
            path="/womens"
            element={<ShopCatagorey banner={women_banner} category="womens" />}
          />
          <Route
            path="/kids"
            element={<ShopCatagorey banner={kids_banner} category="kids" />}
          />
